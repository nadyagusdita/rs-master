                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Jadwal Dokter</h3>
                            <p class="text-subtitle text-muted">Kelola Jadwal Dokter</p>
                        </div>
                    </div>
                    ...
                    <a href="?page=tambahjadwal" class="btn btn-primary mb-1">Tambah Data</a>
                    <div class="col-4">
                    ...
                    <div class="card-body">
                        <table class="table table-striped" id="table1">
                            ...
                            <tbody>
                                ...
                                INNER JOIN jadwal ON jadwal_dokter.id_jadwal = jadwal.id_jadwal";
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?= $row->hari; ?>, <?= $row->jam_mulai; ?>, <?= $row->jam_selesai; ?></td>
                                            <td class="text-center"><?php echo $row->nama_dokter ?></td>
                                            <td>
                                                <a href="jadwal/delete.php?id_jadwal=<?= $row->id_jadwal; ?>&id_dokter=<?= $row->id_dokter; ?>" class="btn icon btn-danger" onclick="return confirm('Anda yakin ingin menghapus?'); "><i class="bi bi-trash"></i></a>
                                                <!-- <a href="?page=editjadwal&id_jadwal=<?= $row->id_jadwal; ?>&id_dokter=<?= $row->id_dokter; ?>" class="btn icon btn-warning"><i class="bi bi-pencil"></i></a> -->
